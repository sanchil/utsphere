...
Using Equation~\eqref{eq:interference_formal} from Axiom~\ref{subsec:axiom3}, combining Red Vector ($0^\circ$) and Blue Vector ($120^\circ$) at coordinate ($0.6, 0.8$) results in deterministic phase blending ($\chi = 66.6^\circ$).
