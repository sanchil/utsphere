...
%\title{Pattern Arithmetic: a Typed Algebra of Units on a Phase-Colored Sphere}
...
reading many co-present units of truth --- seated units, and later
learned ones --- through a path. That is a computation of
\emph{presence and order}, not a substitute for a field equation.
...
\begin{equation}
    ...
    \chi &\in [0,2\pi),
    \qquad
    \tau \in \{\mathtt{word},\,\mathtt{num},\,\mathtt{color},\,\mathtt{note\text{-}pitch},\,\ldots\}.
    \end{aligned}
    \label{eq:unit_truth}
\end{equation}
...
$\mathrm{queen}\approx\mathrm{king}-\mathrm{man}+\mathrm{woman}$
