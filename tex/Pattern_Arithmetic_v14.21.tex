...
normalize (Recipe~1) is recorded as a cheaper cousin. This paper
uses Recipe~2 so the copied step stays on the skin of the ball.
...
open a fifth. $R$ is a bowl, not a blended 4-tuple. Mix is a different
