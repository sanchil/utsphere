...
phase-color $\chi_i\in[0,2\pi)$ alongside $(r_i,\hat n_i)$, sharing
the atom's own sort $\tau$, and each independently an instance of
that same 4-tuple, still capped at $r_i\le 1$. $N$ is the atom's info
