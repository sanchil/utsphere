...
\label{subsec:register_scope}
This section claims only that one sphere can \emph{host} both alphabets
as a workspace. It does not claim that the two-dimensional surface
...
an external lookup table that writes states into the register.
