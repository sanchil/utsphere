...
what $C$ would otherwise have cancelled. $\boxplus$ is commutative,
...
$(\mathtt{note},\mathtt{note})$ & no & yes & yes & yes & open \\
\hline
\end{tabular}
...
$\mathtt{color}$ and $\mathtt{note}$ are the Tier-1 sorts of
