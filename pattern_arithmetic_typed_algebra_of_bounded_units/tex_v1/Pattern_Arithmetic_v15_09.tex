...
choice, stated once, suffices; this paper's worked examples do not
yet exercise one.
...
$T$'s own piece of this is no longer speculative:
\S\ref{subsec:transform_higher_dim} gives the construction, checked
directly rather than assumed, invertible and non-commutative at
$N_{\mathrm{dim}}$ up to $12$ and exact at $N_{\mathrm{dim}}=3$. What
remains open is the rest --- Mix, Assembly, and the transport
formula's own proof steps in general $N_{\mathrm{dim}}$.
